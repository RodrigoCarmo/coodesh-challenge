...
export class CreateProductsFilesManagerJobPerformace1687340519971 implements MigrationInterface {
    name = 'CreateProductsFilesManagerJobPerformace1687340519971'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "jobs_performance" ("id" SERIAL NOT NULL, "total_duration" character varying NOT NULL, "cpu_usage_average" character varying NOT NULL, "memory_usage" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_659ef0c870bdfa9d4d6585ac746" PRIMARY KEY ("id"))`);
    }
